...
//Sets session data for Admin in the time of login
	...
	//Returns user informations for editing purpose
	...
	//Returns activity information of all users for displaying in Dashboard
